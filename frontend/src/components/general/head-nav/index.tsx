...
const HeadNav: React.FC<HeadNavProps> = ({ pageName, subPageFlag, style = "blue" }) => {
  ...
  const navTextColor = style === "blue" ? "#d4a95a" : style === "yellow" ? "#185f65" : undefined;
  const backgroundColor = style === "blue" ? "#185f65" : style === "yellow" ? "#d4a95a" : undefined;

  const renderNavText = () => (
    <div className="nav-text" style={pageName === "о компании" ? { color: "white" } : { color: navTextColor }}>
        ...
        <div className="wrapper">
          <div className="left" onClick={handleGoBack}>
            <div style={{ display: "inline-flex", alignItems: "center" }}>
              ...
              >
                <path
                  style={pageName === "о компании" ? { fill: "white" } : { fill: navTextColor }}
              ...
              <p style={pageName === "о компании" ? { color: "white" } : { color: navTextColor }}>Назад</p>
            </div>
            <h4 style={pageName === "о компании" ? { color: "white" } : { color: navTextColor }}>{pageName}</h4>
          </div>
          {!subPageFlag && (
            <div className="right">
