...
const stimiksstandartkukuruza = () => {
  ...
  const jsx_content_wrapped = wrapUntaggedTextWithP(
    <div>
      <strong>
        <a href="https://berkanabio.ru/wp-content/uploads/2019/09/stimiks-standart-kukuruza.jpeg"></a>
      ...
      <h2>Состав</h2>
      <ul>
        <li>Свободные аминокислоты - не менее 20 г/л</li>
  ...
  return (
    <>
      <Head>
        <title>Стимикс® Стандарт Кукуруза - Berkana</title>
      ...
      <Layout style={(headerStyle, pathStyle)}>
        <HeadNav
          pageName="Стимикс® Стандарт Кукуруза"
          style={style}
          pathStyle={pathStyle}
        />
...
export default stimiksstandartkukuruza;
