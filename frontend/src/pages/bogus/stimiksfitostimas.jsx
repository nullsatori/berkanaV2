...
const stimiksfitostimas = () => {
  ...
  const jsx_content_wrapped = wrapUntaggedTextWithP(
    <div>
      <a href="https://berkanabio.ru/wp-content/uploads/2019/09/stimiks-fitostim-as.jpeg"></a>
      ...
      Заселяет корневую систему эпифитными и эндофитными азотофиксирующими
      бактериями. Обеспечивает растения биологическим азотом и фитогормонами
      микробного происхождения.
      <h2>Состав</h2>
      <ul>
        <li>Живые микробные культуры.</li>
        <li>
          Высокоактивные штаммы азотофиксирующих симбиотических (не
          ризобиальных) микроорганизмов.
        </li>
      ...
      Стимикс<sup>®</sup>Фитостим As наносится на семена. Рекомендуется
      применять как самостоятельно, так и в баковых смесях со Стимиксом Семя,
       Фитостимом Аb, а также вместе с совместимыми химическими фунгицидами,
      стимуляторами роста и минеральными удобрениями.
      <h3>Безопасность</h3>
  ...
  return (
    <>
      <Head>
        <title>Стимикс®Фитостим As - Berkana</title>
...
export default stimiksfitostimas;
