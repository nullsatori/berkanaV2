...
const stimiksstandartsoja = () => {
  ...
  const jsx_content_wrapped = wrapUntaggedTextWithP(
    <div>
      <strong>
        <a href="https://berkanabio.ru/wp-content/uploads/2019/09/stimiks-standart-soya.jpeg"></a>
      ...
      зернобобовых культур. Повышение урожайности и устойчивости к стрессам
      (жара, заморозки, засуха и т.п. ). Стимулирование роста и развития
      растений. Снятие эффекта "гербицидной ямы". Повышение качества продукции.
      <h3>Действие препарата</h3>
      Устраняет блокаду белкового синтеза, остановленного токсинами возбудителей
      бактериозов и других фитопатогенов. Инактивирует токсины. Усиливает
      фотосинтез. Восстанавливает нарушенный транспорт сахаров.
      <h2>Состав</h2>
      <ul>
        <li>Свободные аминокислоты - не менее 10 г/л</li>
        <li>Соли гуминовых кислот - не  менее 30 г/л</li>
      ...
      <h2>Применение</h2>
      <ul>
        <li>Вид обработки: некорневая подкормка</li>
        <li>Расход препарата: 1л/га</li>
  ...
  return (
    <>
      <Head>
        <title>Стимикс®Стандарт Соя - Berkana</title>
...
export default stimiksstandartsoja;
