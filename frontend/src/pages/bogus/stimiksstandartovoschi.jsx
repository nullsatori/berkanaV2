...
const stimiksstandartovoschi = () => {
  ...
  const jsx_content_wrapped = wrapUntaggedTextWithP(
    <div>
      <strong>
        <a href="https://berkanabio.ru/wp-content/uploads/2019/09/stimiks-standart-ovoshhi.jpeg"></a>
      ...
      овощных культур. Повышение урожайности и устойчивости к стрессам (жара,
      заморозки, засуха и т.п. ). Стимулирование роста и развития растений.
      Снятие эффекта "гербицидной ямы". Снижение количества нитратов в
      продукции. Улучшение вкусовых качеств. Увеличение срока хранения.
  ...
  return (
    <>
      <Head>
        <title>Стимикс® Стандарт. Овощи - Berkana</title>
      ...
      <Layout style={(headerStyle, pathStyle)}>
        <HeadNav
          pageName="Стимикс® Стандарт. Овощи"
          style={style}
          pathStyle={pathStyle}
        />
...
export default stimiksstandartovoschi;
