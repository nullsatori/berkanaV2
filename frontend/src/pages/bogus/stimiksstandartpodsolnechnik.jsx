...
const stimiksstandartpodsolnechnik = () => {
  let style = {
    background: "#185F65",
    color: "#D4A95A",
  };
  ...
  const jsx_content_wrapped = wrapUntaggedTextWithP(
    <div>
      <strong>
        <a href="https://berkanabio.ru/wp-content/uploads/2019/09/stimiks-standart-podsolnechnik.jpeg"></a>
      ...
      масличных культур. Повышение урожайности и устойчивости к стрессам (жара,
      заморозки, засуха и т.п. ). Стимулирование роста и развития растений.
      Снятие эффекта "гербицидной ямы". Повышение качества продукции.
      <h3>Действие препарата</h3>
      Устраняет блокаду белкового синтеза, остановленного токсинами возбудителей
      бактериозов. Инактивирует токсины. Усиливает фотосинтез. Восстанавливает
      нарушенный транспорт сахаров.
      <h2>Состав</h2>
      <ul>
        <li>Свободные аминокислоты - не менее 30 г/л</li>
        <li>Соли гуминовых кислот - не менее 30-50 г/л</li>
  ...
  return (
    <>
      <Head>
        <title>Стимикс®Стандарт Подсолнечник - Berkana</title>
      ...
      <Layout style={(headerStyle, pathStyle)}>
        <HeadNav
          pageName="Стимикс®Стандарт Подсолнечник"
          style={style}
          pathStyle={pathStyle}
        />
...
export default stimiksstandartpodsolnechnik;
