...
const evrohimn6p14k35 = () => {
  ...
  const jsx_content_wrapped = wrapUntaggedTextWithP(
    <div>
      ...
      Комплексное водорастворимое удобрение с повышенным содержанием калия и
      магнием в составе. Наибольший эффект от их внесения наблюдается на
      финальных фазах вегетации. Применение на овощных культурах, сахарной
      свекле, картофеле, луке способствует дозреванию за счет оттока питательных
      веществ из вегетативных органов в запасающие, улучшает вкусовые качества,
      товарный вид и лежкость продукции.
      <h2>Состав</h2>
      NPK 6:14:35 + 2MgО (S-2%, MgO-2%, B-0,02%, Cu-0,005%, Mn-0,005%, Zn-0,01%,
      Fe-0,07%, Mo-0,004%)
      <h3>Применение</h3>
  ...
  return (
    <>
      <Head>
        <title>Еврохим N6–P14–K35 - Berkana</title>
...
export default evrohimn6p14k35;
