...
const stimiksstandartsvekla = () => {
  ...
  const jsx_content_wrapped = wrapUntaggedTextWithP(
    <div>
      <strong>
        <a href="https://berkanabio.ru/wp-content/uploads/2019/09/stimiks-standart-svekla.jpeg"></a>
      ...
      овощных культур (корнеплодов). Повышение урожайности и устойчивости к
      стрессам (жара, заморозки, засуха и т.п. ). Стимулирование роста и
      развития растений. Снятие эффекта "гербицидной ямы". Повышение
      сахаристости корнеплодов. Повышение устойчивости к кагатной гнили.
  ...
  return (
    <>
      <Head>
        <title>Стимикс®Стандарт Свекла - Berkana</title>
      ...
      <Layout style={(headerStyle, pathStyle)}>
        <HeadNav
          pageName="Стимикс®Стандарт Свекла"
          style={style}
          pathStyle={pathStyle}
        />
...
export default stimiksstandartsvekla;
