import React from 'react';
            ...
            const nashipartnerykalachevgvglagronomshahoperskijpionervolgogradskajaobl = () => {
                let style= {
                    background: '#185F65',
                    color: '#D4A95A',
                };
                ...
                const jsx_content_wrapped = wrapUntaggedTextWithP(<div>https://youtu.be/ylXADCRUz_Q
...
<strong>Компания БЕРКАНА</strong> — предлагает услуги по поставке химических и биологических средств защиты растений, регуляторов и стимуляторов роста, семян технических культур и др. Наши специалисты оказывают технологическую и консультационную помощь сельскохозяйственным предприятиям. Мы внедряем биологические технологии восстановления естественного плодородия почвы и повышения урожайности.</div>);
                ...
                return (
                    <>
                        <Head>
                            <title>Наши партнеры. Калачев Г.В. - Гл.агроном СХА "Хоперский пионер" Волгоградская обл. - Berkana</title>
                            <meta name="description" content="Generated by create next app" />
                            <meta name="viewport" content="width=device-width, initial-scale=1" />
                            <link rel="icon" href="/favicon.ico" />
                        </Head>
                        <Layout style={headerStyle, pathStyle}>
                            <HeadNav pageName="Наши партнеры. Калачев Г.В. - Гл.агроном СХА "Хоперский пионер" Волгоградская обл." style={style} pathStyle={pathStyle} />
            ...
            export default nashipartnerykalachevgvglagronomshahoperskijpionervolgogradskajaobl;
