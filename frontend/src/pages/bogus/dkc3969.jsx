...
const dks3969 = () => {
  ...
  const jsx_content_wrapped = wrapUntaggedTextWithP(
    <div>
      <strong>BAYER</strong>
      Простой среднеспелый гибрид универсального направления. ФАО 290 Тип зерна:
      Кремнисто-зубовидный Количество зёрен в початке: 600 – 720 шт
      ...
      Высота крепления 80 – 95 см. Цилиндрическо-коническая форма. Длина 20 – 24
      см. Диаметр 4,5 – 5 см.
      <table>
        <tbody>
          <tr>
  ...
  return (
    <>
      <Head>
        <title>ДКС 3969 - Berkana</title>
        <meta name="description" content="Generated by create next app" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <Layout style={(headerStyle, pathStyle)}>
        <HeadNav pageName="ДКС 3969" style={style} pathStyle={pathStyle} />
