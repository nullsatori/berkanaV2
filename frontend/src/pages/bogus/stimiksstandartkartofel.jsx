...
const stimiksstandartkartofel = () => {
  ...
  const jsx_content_wrapped = wrapUntaggedTextWithP(
    <div>
      <strong>
        <a href="https://berkanabio.ru/wp-content/uploads/2019/09/stimiks-standart-kartofel.jpeg"></a>
      ...
      картофеля, томатов и др.пасленовых культур. Повышение урожайности и
      устойчивости к стрессам (жара, заморозки, засуха и т.п. ). Стимулирование
      роста и развития растений. Снятие эффекта "гербицидной ямы". Снижение
      количества нитратов в продукции. Улучшение вкусовых качеств. Увеличение
      срока хранения.
      <h2>Действие препарата</h2>
      Устраняет блокаду белкового синтеза, остановленного токсинами почвенных
      фитопатогенов. Инактивирует токсины. Усиливает фотосинтез за счет
      повышения активности хлоропластов. Восстанавливает нарушенный транспорт
      сахаров.
      <h2>Состав</h2>
      <ul>
        <li>Свободные аминокислоты - не менее 10 г/л</li>
        <li>Соли гуминовых кислот - 40 г/л</li>
        <li>Живые микробные культуры</li>
        <li>Органический кремний</li>
        <li>Биологически активные вещества</li>
      </ul>
      <h3>Применение</h3>
      Вид обработки: некорневая подкормка, полив под корень При некорневой
      подкормке: расход препарата - 1л/га; объем рабочей жидкости: 200-250 л/га;
      количество обработок: 1-7. При поливе под корень: расход препарата - 1л на
      200л воды.
  ...
  return (
    <>
      <Head>
        <title>Стимикс® Стандарт. Картофель - Berkana</title>
      ...
      <Layout style={(headerStyle, pathStyle)}>
        <HeadNav
          pageName="Стимикс® Стандарт. Картофель"
          style={style}
          pathStyle={pathStyle}
        />
...
export default stimiksstandartkartofel;
