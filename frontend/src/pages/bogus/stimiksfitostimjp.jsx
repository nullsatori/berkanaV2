...
const stimiksfitostimjp = () => {
  ...
  const jsx_content_wrapped = wrapUntaggedTextWithP(
    <div>
      <a href="https://berkanabio.ru/wp-content/uploads/2019/09/stimiks-fitostim-jp.jpeg.jpeg"></a>
      Заселение поверхности растений и почвы сапрофитной микрофлорой защитного и
      ростостимулирующего действия. Разуплотнение почвы.  Стимулирование
      процесса почвообразования. Улучшение минерального питания растений.
      ...
      ризосфере. Препарат обладает выраженным ростостимулирующим действием. При
      внесении в почву инициирует процессы разуплотнения и почвообразования.
      <h2>Состав</h2>
      <ul>
        <li>
          Высокоактивные штаммы азотофиксирующих, молочнокислых и
          фотосинтезирующих микроорганизмов - антагонистов патогенных грибов и
          бактерий.
        </li>
      ...
      препарата при разведении не должна превышать 10°С. Фитостим Jp
  ...
  return (
    <>
      <Head>
        <title>Стимикс®Фитостим Jp - Berkana</title>
...
export default stimiksfitostimjp;
