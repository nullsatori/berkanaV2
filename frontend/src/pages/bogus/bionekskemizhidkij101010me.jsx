...
const bionekskemizhidkij101010me = () => {
  let style = {
    background: "#185F65",
    color: "#D4A95A",
  };
  ...
  const jsx_content_wrapped = wrapUntaggedTextWithP(
    <div>
      <strong>
        <a href="https://berkanabio.ru/wp-content/uploads/2019/09/Bioneks_Kemi-ZHidkiy-NPK-101010_ME.jpeg"></a>
  ...
  return (
    <>
      <Head>
        <title>Бионекс-Кеми Жидкий (10+10+10+МЭ) - Berkana</title>
      ...
      <Layout style={(headerStyle, pathStyle)}>
        <HeadNav
          pageName="Бионекс-Кеми Жидкий (10+10+10+МЭ)"
          style={style}
          pathStyle={pathStyle}
        />
...
export default bionekskemizhidkij101010me;
